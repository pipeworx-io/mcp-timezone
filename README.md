...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/get_time_by_timezone \
  -H 'Content-Type: application/json' \
  -d '{"timezone":"America/New_York"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/get_time_by_timezone`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
